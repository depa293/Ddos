...
title: global.proxy,
body: `Jangan attack sblum selesai`,
mediaType: 1,  
thumbnailUrl: global.standby,
sourceUrl: ``
}}, text: 'Updating...'}, {quoted: m})
        exec(`node ./lib/SkyranXMODS/scrape.js`, (error, stdout, stderr) => {
            if (error) {
...
sourceUrl: ``
    ...
    conn.sendFile(m.chat, proxyPath, 'SkyranXMods_Proxy.txt', 'Downloaded Proxy...');
    } else {
